...
add_action('send_custom_pmt_reminder_invoice_emails', function () {
    ...
    if (!empty($order_ids)) :
        ...
        foreach ($order_ids as $order_id) :
            ...
            if ($age_in_days >= 90 && $three_month_sent === 'yes' || $age_in_days >= 60 && $two_month_sent === 'yes' || $age_in_days >= 30 && $one_month_sent === 'yes' || $age_in_days >= 14 && $two_week_sent === 'yes' || $age_in_days >= 7 && $one_week_sent === 'yes') :
